class AppLink {
  static const String server = "https://aldemashqy.com/wp-json";
//
  static const String test = "$server/custom-api1/v1/ads/";
  ...
  static const String mainads = "$server/custom/v1/mainads";
  ...
  static const String getproduct = "$server/app/v1/ad_post1";
  static const String addcomment = "$server/custom/v1/add_comment";
  static const String getmorecomment = "$server/app2/v1/comments";
  static const String addproduct = "$server/adforest/v1/add-ad/";
